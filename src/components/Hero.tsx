  ...
  return (
    <section ref={hero} className="w-full flex flex-col items-center h-[300vh]">
      ...
      >
        ...
        <div className="overflow-hidden absolute bottom-10 left-10 z-10 mix-blend-exclusion w-3/4">
          <p
            ref={heroTextSlogan}
            className="text-[clamp(1rem,7vw,2.5rem)] leading-[1.2] text-white font-light"
          >
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 mix-blend-exclusion">
          <svg
            ...
            className="w-[clamp(200px,70vw,1500px)] h-auto"
          >
            <path
